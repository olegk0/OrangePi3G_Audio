...
class AudioMTKStreamManager : public AudioMTKStreamManagerBase {
   public:
     ...
     * do closeInputStream
     * @return status_t*/
    virtual status_t closeInputStream(AudioStreamIn *in);

    /**
     * do closeOutputStream
     * @return status_t*/
    virtual status_t closeOutputStream(AudioStreamOut *out);
   ...
   private:
    ...
    KeyedVector<uint32_t, AudioStreamIn *> mStreamInVector;  // vector to save current recording client
    uint32_t mStreamOutNumber;
    KeyedVector<uint32_t, AudioStreamOut *> mStreamOutVector;  // vector to save current recording client
};
